...
?>
    <header id="header">
    <div class="header-escudo"><a href="./home-doc.html" class="header-link"><img src="../../img/escudo.png" class="escudo-header"><h2 class="header-brand"> ConcursAR</h2></a></div>
    ...
    <article id="article">
        ...
        <ul class="home-opt">
            <li><a href="./actos-publicos.html" class="opt-btn white-font">Ver Actos Públicos</a></li>
            <li> <a href="./escuelas.html" class="opt-btn white-font">Ver escuelas</a></li>
            <li> <a href="./mi-postulacion.html" class="opt-btn white-font">Mi postulación</a></li>
            <li> <a href="./calendario.html" class="opt-btn white-font">Próximas fechas</a></li>
        </ul>
