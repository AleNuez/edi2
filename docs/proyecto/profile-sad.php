...
<main>
                        ...
                        <form
                            ...
                            <div style="justify-content:space-between; display:flex;" class="botonera">
                                <input
                                    ...
                                    class="login-btn"
                                    value="Cargar">
                                <!-- style="padding:0rem 3rem;margin:0.3rem 0.3rem;" <a class="close-btn" href="./profile-sad.php">Cancelar</a> -->
                            </div>
                        </form>
                    </div>
            ...
            ?>
                                ...
                                <a href="./profile-sad.php" class="close-btn">Cerrar</a>
                            </form>
                        </div>
