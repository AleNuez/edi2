...
if($resultado['filas']>0){  // Si hay un resultado en el array...
    ...
    $action = "UPDATE users SET password='$password',nombre='$nombre',apellido='$apellido',dob='$dob',puntaje='$puntaje',documentacion='$documentacion',provincia='$provincia',region='$region',distrito='$distrito',area='$area',especialidad='$especialidad' WHERE user = '$globaluser'" ; // 
